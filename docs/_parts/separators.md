...
official [BEM methodology naming convention][bem-guide]
or even custom ones.
...
For details on naming principles, refer to the official [BEM methodology guide][bem-guide].
:::

[bem-guide]: https://en.bem.info/methodology/naming-convention/
